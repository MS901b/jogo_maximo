	var codigo_do_software = "maximo";
	var nome_do_software = "Explorando o Jogo do Máximo";
	var tipo = "software";
	...
	var FichaTecnica = $H({
		...
		sinopse: {
			titulo: 'Sinopse',
			conteudo: 'Este software explora noções básicas do cálculo de probabilidades, tais como eventos e independência. O experimento aleatório considerado baseia-se no máximo obtido no lançamento de dois dados comuns.'
		},
		conteudos: {
			titulo: 'Conteúdo',
		...
		objetivos: {
			titulo: 'Objetivos',
			conteudo: 'Investigar, primeiramente através de uma abordagem frequentista e depois através do cálculo das probabilidades teóricas, um jogo no qual os participantes apostam na maior face obtida no lançamento de dois dados comuns.'
		},
		duracao: {
			titulo: 'Duração',
